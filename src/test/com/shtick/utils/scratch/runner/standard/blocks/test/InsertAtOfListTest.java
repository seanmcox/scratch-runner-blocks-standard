...
import com.shtick.utils.scratch.runner.standard.blocks.InsertAtOfList;
...
class InsertAtOfListTest {

	@Test
	void testOpcode() {
		InsertAtOfList op = new InsertAtOfList();
		assertEquals("insert:at:ofList:",op.getOpcode());
	}

	@Test
	void testArgumentTypes() {
		InsertAtOfList op = new InsertAtOfList();
		assertArrayEquals(new DataType[] {DataType.OBJECT,DataType.OBJECT,DataType.STRING}, op.getArgumentTypes());
	}
	...
	void testArgs() {
		...
		{ // 0
			...
			Object retval = op.execute(new AllBadRuntime(), new StackTraceRunner(), sprite, new Object[] {"l",0,"A"});
			assertNull(retval);
			assertEquals(3,sprite.getContextListByName("A").getItemCount());
			assertEquals("A",sprite.getContextListByName("A").getItem(1));
			assertEquals("B",sprite.getContextListByName("A").getItem(2));
		...
		{ // 1
			...
			assertEquals("B",sprite.getContextListByName("A").getItem(2));
			assertEquals("C",sprite.getContextListByName("A").getItem(3));
			Object retval = op.execute(new AllBadRuntime(), new AllBadRunner(), sprite, new Object[] {1,1,"A"});
			assertNull(retval);
			assertEquals(4,sprite.getContextListByName("A").getItemCount());
			assertEquals(1,sprite.getContextListByName("A").getItem(1));
			assertEquals("A",sprite.getContextListByName("A").getItem(2));
			assertEquals("B",sprite.getContextListByName("A").getItem(3));
			assertEquals("C",sprite.getContextListByName("A").getItem(4));
		}
		...
		{ // 2
			...
			assertEquals("B",sprite.getContextListByName("A").getItem(2));
			assertEquals("C",sprite.getContextListByName("A").getItem(3));
			Object retval = op.execute(new AllBadRuntime(), new AllBadRunner(), sprite, new Object[] {"owl",2,"A"});
			assertNull(retval);
			assertEquals(4,sprite.getContextListByName("A").getItemCount());
			assertEquals("A",sprite.getContextListByName("A").getItem(1));
		...
		{ // last
			...
			assertEquals("B",sprite.getContextListByName("A").getItem(2));
			assertEquals("C",sprite.getContextListByName("A").getItem(3));
			Object retval = op.execute(new AllBadRuntime(), new AllBadRunner(), sprite, new Object[] {"l","last","A"});
			assertNull(retval);
			assertEquals(4,sprite.getContextListByName("A").getItemCount());
			assertEquals("A",sprite.getContextListByName("A").getItem(1));
			assertEquals("B",sprite.getContextListByName("A").getItem(2));
			assertEquals("C",sprite.getContextListByName("A").getItem(3));
			assertEquals("l",sprite.getContextListByName("A").getItem(4));
		}
		...
		{ // 4
			...
			assertEquals("B",sprite.getContextListByName("A").getItem(2));
			assertEquals("C",sprite.getContextListByName("A").getItem(3));
			Object retval = op.execute(new AllBadRuntime(), new StackTraceRunner(), sprite, new Object[] {"l",4,"A"});
			assertNull(retval);
			assertEquals(4,sprite.getContextListByName("A").getItemCount());
			assertEquals("A",sprite.getContextListByName("A").getItem(1));
			assertEquals("B",sprite.getContextListByName("A").getItem(2));
		...
		{ // 5
			...
			assertEquals("B",sprite.getContextListByName("A").getItem(2));
			assertEquals("C",sprite.getContextListByName("A").getItem(3));
			Object retval = op.execute(new AllBadRuntime(), new StackTraceRunner(), sprite, new Object[] {"l",5,"A"});
			assertNull(retval);
			assertEquals(3,sprite.getContextListByName("A").getItemCount());
			assertEquals("A",sprite.getContextListByName("A").getItem(1));
			assertEquals("B",sprite.getContextListByName("A").getItem(2));
		...
		{ // random
			AllBadSprite sprite = new ListySprite();
			assertEquals(3,sprite.getContextListByName("A").getItemCount());
			Object retval = op.execute(new AllBadRuntime(), new AllBadRunner(), sprite, new Object[] {"rand","random","A"});
			assertNull(retval);
			assertEquals(4,sprite.getContextListByName("A").getItemCount());
		...
		try{ // Bad value
			AllBadSprite sprite = new ListySprite();
			op.execute(new AllBadRuntime(), new AllBadRunner(), sprite, new Object[] {null,1,"A"});
		...
		try{ // Bad value
			AllBadSprite sprite = new ListySprite();
			op.execute(new AllBadRuntime(), new AllBadRunner(), sprite, new Object[] {1,null,1});
			fail("Exception expected.");
		}
		catch(Throwable t) {
			// Expected result.
