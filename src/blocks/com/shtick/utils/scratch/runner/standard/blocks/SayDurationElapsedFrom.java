 ...
 *
 */
public class SayDurationElapsedFrom implements OpcodeAction {
	...
	public String getOpcode() {
		return "say:duration:elapsed:from:";
	}
	...
	public OpcodeSubaction execute(ScratchRuntime runtime, ScriptTupleRunner scriptRunner, ScriptContext context,
		...
		Image bubbleImage = StandardFeatureGenerator.createTalkBubbleImage(s0);
